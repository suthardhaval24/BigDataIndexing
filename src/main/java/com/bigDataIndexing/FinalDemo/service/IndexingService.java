...
/* dhaval created on 4/6/20 inside the package - com.bigDataIndexing.FinalDemo.service */
        ...
        while (true) {
            ...
            if (bytes != null && bytes.length != 0) {
                try {
                    ...
                    restHighLevelClient.index(new IndexRequest("insurance_plan_index", objectType, objectId).source(bytes, XContentType.JSON));
                    // restHighLevelClient.close();
                    logger.info("Index: insurance_plan_index, " + "Type=" + objectType + " , Id=" + objectId + " added to ElasticSearch.");
                } catch (IOException e) {
